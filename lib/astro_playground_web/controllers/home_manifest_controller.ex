defmodule AstroPlaygroundWeb.HomeManifestController do
  ...
  operation :show,
    summary: "Home-page render manifest",
    description: "The precomputed grouping + per-system renderability that drives the grouped home page (generated by `mix astro.manifest`).",
    responses: [ok: {"Manifest", "application/json", Schemas.HomeManifest}]
